...
const PetProfile = () => {
  ...
  const fetchPets = () => {
    // axios.get('http://localhost:8080/api/v1/pet/getAll')
    //   .then((response) => {
...
const handleDeletePet = (id) => {
    // axios.delete(`http://localhost:8080/api/v1/pet/delete/${id}`)
    //   .then(() => {
    //     alert('Pet deleted successfully!');
...
//       <h1 style={{ color: 'black', marginTop: '-20px', marginBottom: '40px' }}>Pet Profile</h1>
