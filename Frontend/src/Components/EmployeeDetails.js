...
//                   <TableCell>
//                   <IconButton onClick={() => handleEdit(emp)}>
//                     <EditIcon style={{ color: '#5D2510' }} /> {/* Custom color */}
//                   </IconButton>

//                   <IconButton onClick={() => deleteEmployee(emp.id)}>
//                     <DeleteIcon style={{ color: '#692f22' }} /> {/* Custom color */}
//                   </IconButton>
...
// // Set up Axios default headers to include the JWT token
...
//   const [currentPage, setCurrentPage] = useState(1);
//   const [employeesPerPage] = useState(5);
//   const [token, setToken] = useState(localStorage.getItem('token')); // Retrieve the JWT from localStorage
