...
//     e.preventDefault(); 
//     axios
//       .get(`http://localhost:8080/api/v1/pet/get/${pet.id}`)
//       .then((response) => {
//         if (response.data) {
//           console.log('Pet found:', response.data);
//           setPet(response.data);
...
//   const handleUpdate = () => {
//     axios
//       .put(`http://localhost:8080/api/v1/pet/update/${pet.id}`, pet)
//       .then((response) => {
//         alert('Pet updated successfully!');
//         resetForm();
//       })
...
//       <h1 style={{ color: 'black', marginTop: '-20px', marginBottom: '40px' }}>Doctor Decision Management</h1>
//       <form>
//         <div className="search-container">
//           <input
//             type="text"
...
//   const [isEditing, setIsEditing] = useState(false);
//   const [token] = useState(localStorage.getItem('token')); // Retrieve the token from localStorage
