...
//     //         // If login is successful, show a message and store the token
//     //         window.alert('Login successful!');
            
//     //         // Optionally save the JWT token here
...
//     //         // localStorage.setItem('token', response.data.jwt);  // Check that 'jwt' is the correct key
...
//             // Correctly access the token from the response
//             // const { jwt } = response.data; // Make sure 'jwt' matches the response key
//             // localStorage.setItem('token', jwt);
